...
/**
 * Builds the static, realistic promotion campaign for a show. Single source of
 * truth for the prototype's campaign content (no AI, networking, or APIs).
 */
export function buildMockCampaign(show: Show): Campaign {
